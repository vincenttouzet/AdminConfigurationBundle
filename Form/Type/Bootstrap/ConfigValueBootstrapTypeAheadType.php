...
/**
 * ConfigValueBootstrapTypeAheadType
 *
 * @category VinceT
 * @package  VinceTAdminConfigurationBundle
 * @author   Vincent Touzet <vincent.touzet@gmail.com>
 ...
 * @link     https://github.com/vincenttouzet/AdminConfigurationBundle
 */
class ConfigValueBootstrapTypeAheadType extends AbstractType
{
    /**
     * [getName description]
     *
    ...
    {
        return 'admin_configuration_configvalue_bootstrap_typeahead';
    }
}